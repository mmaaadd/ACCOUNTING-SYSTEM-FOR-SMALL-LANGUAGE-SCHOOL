		...
		while ($dzis>=$poczatek)
			{
					...
					//		echo $pod_suma.'<br>';
						...
						//	echo $do_zaplaty;
								...
								$st.='<tr><td><p>'.$rok.'-'.$miesiac.'</p></td><td><p>'.number_format ( $pod_suma, 2 , ',', ' ').' zł</p></td><td><p>'.number_format ( $zaplac, 2 , ',', ' ').' zł</p></td></td><td><p>'.number_format ( $do_zaplaty, 2 , ',', ' ').' zł</p></td></tr>';
