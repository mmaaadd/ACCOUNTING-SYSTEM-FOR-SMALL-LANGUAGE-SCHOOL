...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": sortuj rosnąco",sSortDescending:": sortuj malejąco"},oPaginate:{sFirst:"Pierwsza",sLast:"Ostatnia",sNext:"Następna",sPrevious:"Poprzednia"},sEmptyTable:"Nie ma nic do wyświetlenia",sInfo:"Wyświetla _START_ to _END_ of _TOTAL_ pozycji",sInfoEmpty:"Wyświetla pozycje od 0 do 0 z 0 ",sInfoFiltered:"(wyfiltrowano z _MAX_)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Wyświetl _MENU_ pozycji",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Szukaj:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
